...
function externalScripts() {
  ...
  var closCarousel237 = (function (sparksObject) {
	externalScripts();
	let index = 0;
  ...
  //debugger;
	  ...
	  function cardsBeenAdded() {
		  ...
		  spkObj.carouselContainerWidth = cardsWidth;
		  spkObj.cardsNumber = cardsNum;
		  
		  console.log("load section resizedObserver - cards before: ", cardsNum, cardsWidth);
		  console.log('screen-size ', window.screen.width);
		  console.log('num of cards ', cardsNum);
		  
		  spkObj.resizedObserverLoaded = cardsWidth > 0 ? true : false;
		  spkObj.screenSizeRenderedOn = window.screen.width;
		  ...
		  if (cardsNum) {
			  ...
			  if(window.screen.width > 1024) {
				  ...
				  spkObj.greeting = insertGreeding.textContent;
				  ...
				  spkObj.greetingHidden =  true;
				  spkObj.noflowOn = true;
	  ...
	  fetch(url, {
		...
		.then((res) => {
		  ...
		  window.localStorage.setItem(
			"sparkOptionsComplete", JSON.stringify(res)
		  );
		});
	}
