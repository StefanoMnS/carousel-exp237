 ...
 function externalScripts() {
  ...
  @media only screen and (min-width: 1025px) {
   ...
   `;
    ...
    return {
      ...
      anim: function(crds) { 
        let observer = new IntersectionObserver(function(entries,self) {
          //let isTars = document.querySelector('#main-wrapper--exp237 #content').children;
          let tars = Array.from(crds);
          //arr
          tars = entries.map(ent => {
    ...
    `;
        ...
        this.anim(cat.parentElement.insertBefore(carsl, cat));
      },
  ...
  window.addEventListener("load", function () {
    ...
    // let grabAni = this.animation();
        ...
        //     Promise.resolve();
        //     let crs = document.getElementById('content');
        //     crs.classList.remove('hidden');
        //     window.gsap.to(crs.children, {
        //       duration:2,
        //       opacity: 1,
        //       stagger: 0.2,
        //       y: - 1000
